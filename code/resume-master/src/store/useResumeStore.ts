...
const LEGACY_DEFAULT_AVATAR = "/avatar.png";
const CURRENT_DEFAULT_AVATAR = "/maoli.png";

const migrateDefaultAvatar = (resume: ResumeData): ResumeData => {
  if (resume.basic?.photo !== LEGACY_DEFAULT_AVATAR) {
    return resume;
  }
  ...
  persist<ResumeStore>(
    ...
    }),
    {
      ...
      merge: (persistedState, currentState) => {
        ...
        const sourceResumes = persisted.resumes ?? currentState.resumes;
